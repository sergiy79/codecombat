...
If you have [vagrant](http://www.vagrantup.com/) and virtualbox installed, you can clone [https://github.com/dpen2000/Codecombat-Vagrant](https://github.com/dpen2000/Codecombat-Vagrant) and then run ```vagrant up``` to have a VM auto-provisioned for you, with folder mappings, the website available at http://localhost:3000/ on your host machine and the latest mongo data auto restored into your Mongo instance (included in VM). More details in the [https://github.com/dpen2000/Codecombat-Vagrant/blob/master/README.md](Readme).  
