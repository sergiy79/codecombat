...
There is only one difference that you need to be aware of when editing en.coffee.  If you edit a line, you will have to append it with {change} so that the propagator realises that you have made a change and can alert the diplomats for the other coffee files. *requires rewording*
